...
class formWidgetOnebuilderAbout2Options extends cmsForm{
    ...
    public function init() {
        return array( 
            ...
            array(
                ...
                'title' => 'Левая колонка',
                'childs' => array(
                    new fieldImage('options:photo', array(
                        'title' => 'Изображение в левой колонке <span class="badge bg-danger">!</span>',
                        'options' => array('sizes' => array('original')),
                        'hint' => '<mark>В силу специфики разметки данного виджета рекомендуется загружать квадратные изображения (то есть те изображения, у которых соотношение сторон равно по высоте и ширине)</mark>',
                        'rules' => array(array('required'))
                        )),
                        )
                    ),
