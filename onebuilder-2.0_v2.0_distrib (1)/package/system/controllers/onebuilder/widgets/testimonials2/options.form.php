...
class formWidgetOnebuilderTestimonials2Options extends cmsForm{
            ...
            array(
                ...
                'childs' => array(
                    new fieldString('options:title', array(
                        'title' => 'Заголовок секции с отзывами',
                        'hint' => '<mark>Если выводить не требуется - оставьте поле пустым</mark>'
                        )),
                    ...
                    new fieldList('options:p_preset', array(
                        'title' => 'Пресет текста для отзывов',
                        'items' => array(
