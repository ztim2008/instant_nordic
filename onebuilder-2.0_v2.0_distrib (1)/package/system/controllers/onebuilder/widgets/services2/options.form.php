...
class formWidgetOnebuilderServices2Options extends cmsForm{
    ...
    public function init() {
        return array( 
            ...
            array(
                ...
                'childs' => array(
                    new fieldString('options:title', array(
                        'title' => 'Заголовок в левой секции'
                        )),
            ...
            array(
                'type' => 'fieldset',
                'title' => 'Контент правой колонки',
                'childs' => array(
                    new fieldImages('options:icon', array(
                        'title' => 'Иконки записей',
                        'hint' => '<mark>Загрузите ровно столько, сколько хотите выводить записей в блоке</mark>',
                        'options' => array('sizes' => array('original'))
                        )),
                    new fieldText('options:title_s', array(
                        'title' => 'Заголовки записей <span class="badge bg-danger">Каждый с новой строки</span>',
                        'hint' => '<mark>Укажите столько заголовков, сколько выше вы загрузили иконок. Если количество не будет соответствовать, получите ошибку</mark>'
                        )),
                    new fieldText('options:desc', array(
                        'title' => 'Описания записей <span class="badge bg-danger">Каждое через **</span>',
                        'hint' => '<mark>Укажите столько описаний, сколько выше вы загрузили иконок. Если количество не будет соответствовать, получите ошибку</mark>'
                        )),
                    new fieldList('options:p_preset', array(
                        'title' => 'Пресет текста для описаний услуг',
                        'items' => array(
                        ...
                        new fieldList('options:title_preset2', array(
                            'title' => 'Пресет заголовков записей',
                            'items' => array(
                                'h1' => 'H1',
                                'h2' => 'H2',
                                'h3' => 'H3',
