...
return [
	...
	'pro.metrics-grid-pro' => [
		...
		'props_schema'   => [
			...
			['key' => 'data_link_mode', 'type' => 'string', 'title' => 'Режим ссылок'],
			['key' => 'data_link_field', 'type' => 'string', 'title' => 'Поле ссылки'],
			['key' => 'data_link_template', 'type' => 'string', 'title' => 'Шаблон ссылки'],
			['key' => 'data_link_target', 'type' => 'string', 'title' => 'Target ссылки'],
			['key' => 'data_link_rel', 'type' => 'string', 'title' => 'Rel ссылки'],
