<?php
    ...
    // Nordic Smart Grid: перетаскивание для изменения ширины колонок
    if (($template_name ?? '') === 'nordic') {
        $this->addTplJSName('nordic-smart-grid');
        $this->addTplCSSName('nordic-smart-grid');
    }
