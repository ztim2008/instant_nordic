...
if ($headline_contract) {
    ...
    $content_width = (int) ($headline_contract['layout']['desktop']['contentWidth'] ?? 1240);
    $padding_top_desktop = (int) ($headline_contract['layout']['desktop']['paddingTop'] ?? 88);
    $padding_bottom_desktop = (int) ($headline_contract['layout']['desktop']['paddingBottom'] ?? 88);
    $padding_top_mobile = (int) ($headline_contract['layout']['mobile']['paddingTop'] ?? 56);
    $padding_bottom_mobile = (int) ($headline_contract['layout']['mobile']['paddingBottom'] ?? 56);
    ...
    $card_gap_desktop = (int) ($headline_contract['layout']['desktop']['cardGap'] ?? 22);
    $card_gap_mobile = (int) ($headline_contract['layout']['mobile']['cardGap'] ?? 16);
    $header_gap_desktop = (int) ($headline_contract['layout']['desktop']['headerGap'] ?? 24);
    $header_gap_mobile = (int) ($headline_contract['layout']['mobile']['headerGap'] ?? 18);
    $title_size_desktop = (int) (($title_entity['desktop']['fontSize'] ?? 38));
    $title_size_mobile = (int) (($title_entity['mobile']['fontSize'] ?? 28));
    $subtitle_size_desktop = (int) (($subtitle_entity['desktop']['fontSize'] ?? 17));
    $subtitle_size_mobile = (int) (($subtitle_entity['mobile']['fontSize'] ?? 15));
    $meta_size_desktop = (int) (($meta_entity['desktop']['fontSize'] ?? 13));
    $meta_size_mobile = (int) (($meta_entity['mobile']['fontSize'] ?? 12));
    $item_title_size_desktop = (int) (($item_title_entity['desktop']['fontSize'] ?? 18));
    $item_title_size_mobile = (int) (($item_title_entity['mobile']['fontSize'] ?? 17));
    $item_text_size_desktop = (int) (($item_text_entity['desktop']['fontSize'] ?? 15));
    $item_text_size_mobile = (int) (($item_text_entity['mobile']['fontSize'] ?? 14));
    $media_radius = (int) ($media_entity['radius'] ?? 28);
    ...
    $item_surface_radius = (int) ($surface_entity['radius'] ?? 28);
    ...
    $content_width = nb_headline_feed_prop_int($props, 'content_width', 1240, 320, 1600);
    $padding_top_desktop = nb_headline_feed_prop_int($props, 'padding_top_desktop', 88, 0, 300);
    $padding_bottom_desktop = nb_headline_feed_prop_int($props, 'padding_bottom_desktop', 88, 0, 300);
    $padding_top_mobile = nb_headline_feed_prop_int($props, 'padding_top_mobile', 56, 0, 300);
    $padding_bottom_mobile = nb_headline_feed_prop_int($props, 'padding_bottom_mobile', 56, 0, 300);
    ...
    $card_gap_desktop = nb_headline_feed_prop_int($props, 'card_gap_desktop', 22, 0, 120);
    $card_gap_mobile = nb_headline_feed_prop_int($props, 'card_gap_mobile', 16, 0, 120);
    $header_gap_desktop = nb_headline_feed_prop_int($props, 'header_gap_desktop', 24, 0, 120);
    $header_gap_mobile = nb_headline_feed_prop_int($props, 'header_gap_mobile', 18, 0, 120);
    $title_size_desktop = nb_headline_feed_prop_int($props, 'title_size_desktop', 38, 12, 160);
    $title_size_mobile = nb_headline_feed_prop_int($props, 'title_size_mobile', 28, 12, 160);
    $subtitle_size_desktop = nb_headline_feed_prop_int($props, 'subtitle_size_desktop', 17, 10, 80);
    $subtitle_size_mobile = nb_headline_feed_prop_int($props, 'subtitle_size_mobile', 15, 10, 80);
    $meta_size_desktop = nb_headline_feed_prop_int($props, 'meta_size_desktop', 13, 10, 120);
    $meta_size_mobile = nb_headline_feed_prop_int($props, 'meta_size_mobile', 12, 10, 120);
    $item_title_size_desktop = nb_headline_feed_prop_int($props, 'item_title_size_desktop', 18, 10, 80);
    $item_title_size_mobile = nb_headline_feed_prop_int($props, 'item_title_size_mobile', 17, 10, 80);
    $item_text_size_desktop = nb_headline_feed_prop_int($props, 'item_text_size_desktop', 15, 10, 80);
    $item_text_size_mobile = nb_headline_feed_prop_int($props, 'item_text_size_mobile', 14, 10, 80);
    $media_radius = nb_headline_feed_prop_int($props, 'media_radius', 28, 0, 80);
    ...
    $item_surface_radius = nb_headline_feed_prop_int($props, 'item_surface_radius', 28, 0, 100);
