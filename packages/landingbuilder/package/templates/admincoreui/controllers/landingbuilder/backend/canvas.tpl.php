...
<div class="card mb-4">
    <div class="card-body d-flex justify-content-between align-items-start flex-wrap">
        <div>
            ...
            <div class="small text-muted mt-2">API: widgets <code><?php html($screen['api']['widgets_catalog_url']); ?></code> | options <code><?php html($screen['api']['widget_options_url']); ?></code> | save <code><?php html($screen['api']['canvas_save_url']); ?></code></div>
        </div>
...
<div class="row">
    ...
    <div class="col-lg-3 mb-4">
        <div class="card h-100">
            ...
            <div class="card-body">
                <p class="mb-2"><strong>Системные widget-узлы:</strong> <?php echo count($screen['widget_nodes']); ?></p>
