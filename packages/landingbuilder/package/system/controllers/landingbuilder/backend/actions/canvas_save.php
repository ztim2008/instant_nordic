...
class actionLandingbuilderCanvasSave extends cmsAction {
    ...
    public function run() {
        ...
        $page = $this->model->savePageSchema($page_key, $schema, $this->cms_user->id, $version_note);
        if (!$page) {
            return $this->cms_template->renderJSON([
                'error'   => true,
                'message' => 'Canvas save failed. Проверь установку SQL-пакета landingbuilder.'
            ]);
        }
