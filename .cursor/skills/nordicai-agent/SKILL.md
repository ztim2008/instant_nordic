...
**Future product (Template OS):** work from `docs/template-os/MVP-IMPLEMENTATION-PLAN-v0.1.md`; constraints in `DECISION-LOCK-2026-09-10.md`. Kickoff after domain. Do not build inside InstantCMS.
