...
$title_weight_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['title', 'mobile', 'weight'], $title_weight), $title_weight, 400, 900);
...
$title_color = trim((string) nb_hero_panels_editorial_get($entities, ['title', 'desktop', 'color'], ''));
$title_color_mobile = trim((string) nb_hero_panels_editorial_get($entities, ['title', 'mobile', 'color'], $title_color));
...
$eyebrow_weight_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['eyebrow', 'mobile', 'weight'], $eyebrow_weight), $eyebrow_weight, 400, 900);
$eyebrow_color = trim((string) nb_hero_panels_editorial_get($entities, ['eyebrow', 'desktop', 'color'], ''));
$eyebrow_color_mobile = trim((string) nb_hero_panels_editorial_get($entities, ['eyebrow', 'mobile', 'color'], $eyebrow_color));
$eyebrow_line_height = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['eyebrow', 'desktop', 'lineHeightPercent'], 140), 140, 80, 240);
$eyebrow_line_height_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['eyebrow', 'mobile', 'lineHeightPercent'], $eyebrow_line_height), $eyebrow_line_height, 80, 240);
$eyebrow_letter_spacing = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['eyebrow', 'desktop', 'letterSpacing'], 1), 1, -20, 60);
$eyebrow_letter_spacing_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['eyebrow', 'mobile', 'letterSpacing'], $eyebrow_letter_spacing), $eyebrow_letter_spacing, -20, 60);
...
$subtitle_weight_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['subtitle', 'mobile', 'weight'], $subtitle_weight), $subtitle_weight, 400, 900);
$subtitle_color = trim((string) nb_hero_panels_editorial_get($entities, ['subtitle', 'desktop', 'color'], ''));
$subtitle_color_mobile = trim((string) nb_hero_panels_editorial_get($entities, ['subtitle', 'mobile', 'color'], $subtitle_color));
$subtitle_line_height = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['subtitle', 'desktop', 'lineHeightPercent'], 160), 160, 80, 260);
$subtitle_line_height_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['subtitle', 'mobile', 'lineHeightPercent'], $subtitle_line_height), $subtitle_line_height, 80, 260);
$subtitle_letter_spacing = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['subtitle', 'desktop', 'letterSpacing'], 0), 0, -40, 60);
$subtitle_letter_spacing_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['subtitle', 'mobile', 'letterSpacing'], $subtitle_letter_spacing), $subtitle_letter_spacing, -40, 60);
...
$body_weight_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['body', 'mobile', 'weight'], $body_weight), $body_weight, 400, 900);
$body_color = trim((string) nb_hero_panels_editorial_get($entities, ['body', 'desktop', 'color'], ''));
$body_color_mobile = trim((string) nb_hero_panels_editorial_get($entities, ['body', 'mobile', 'color'], $body_color));
$body_line_height = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['body', 'desktop', 'lineHeightPercent'], 170), 170, 80, 260);
$body_line_height_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['body', 'mobile', 'lineHeightPercent'], $body_line_height), $body_line_height, 80, 260);
$body_letter_spacing = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['body', 'desktop', 'letterSpacing'], 0), 0, -40, 60);
$body_letter_spacing_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['body', 'mobile', 'letterSpacing'], $body_letter_spacing), $body_letter_spacing, -40, 60);

$title_line_height = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['title', 'desktop', 'lineHeightPercent'], 110), 110, 70, 240);
$title_line_height_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['title', 'mobile', 'lineHeightPercent'], $title_line_height), $title_line_height, 70, 240);
$title_letter_spacing = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['title', 'desktop', 'letterSpacing'], 0), 0, -60, 60);
$title_letter_spacing_mobile = nb_hero_panels_editorial_prop_int(nb_hero_panels_editorial_get($entities, ['title', 'mobile', 'letterSpacing'], $title_letter_spacing), $title_letter_spacing, -60, 60);

$accent_surface_mode = strtolower(trim((string) nb_hero_panels_editorial_get($entities, ['accentSurface', 'backgroundMode'], 'solid')));
if (!in_array($accent_surface_mode, ['solid', 'transparent'], true)) {
    $accent_surface_mode = 'solid';
}
$accent_surface_color = trim((string) nb_hero_panels_editorial_get($entities, ['accentSurface', 'backgroundColor'], ''));
...
$body_surface_mode = strtolower(trim((string) nb_hero_panels_editorial_get($entities, ['bodySurface', 'backgroundMode'], 'solid')));
if (!in_array($body_surface_mode, ['solid', 'transparent'], true)) {
    $body_surface_mode = 'solid';
}
$body_surface_color = trim((string) nb_hero_panels_editorial_get($entities, ['bodySurface', 'backgroundColor'], ''));
